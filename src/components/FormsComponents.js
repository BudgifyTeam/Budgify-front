...
export function CheckTerm(props) {
  return (
    <div id="Term" style={{marginLeft: "5%", display: "flex", alignItems: "flex-end", flexWrap: "nowrap" }}>
      <div>
        <tr>
          <td><input type="checkbox" id="myCheckbox" checked={props.checked} onChange={props.onChange}/></td>
          <td>{props.terms}</td>
        </tr>
